...
function Users(){
    ...
    return (
        <div id='user-section'>
            <ul id='user-list'>
            <li className='user-list-item'><i className="fa fa-circle fa-circle-online" aria-hidden="true"></i> {user.username} <span id='you'>(you)</span> <span id='user-typing'>{user.typing ? 'Typing...' : null}</span></li>
